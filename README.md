# Trip Type Prediction - Machine Learning (Classification) Project
...
- Train machine learning model to classify trip types
...
- *Pandas* → Data manipulation and tabular structures analysis
